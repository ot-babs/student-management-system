...
class MainWindow(QMainWindow):
    ...
    def load_data(self):
        connection = Database_Connecton().connect()
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """ 
        This app was created for saving details bout peoples content.
        """
...
class DeleteDialog(QDialog):
    ...
    def delete_student(self):
        ...
        # Get selected row index and student id from selected row
        index = main_window.table.currentRow()
